...
ActiveRecord::Schema.define(version: 20170126155847) do
  ...
  create_table "rapidfire_surveys", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "survey_setting_id"
    t.index ["survey_setting_id"], name: "index_rapidfire_surveys_on_survey_setting_id", using: :btree
  end
